	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 appendResult46 = (float4(( appendResult45 * shadow69 ) , (( _AfterTeared )?( ( ( 1.0 - mask57 ) * texAlpha83 ) ):( break44.a ))));
...
/*ASEBEGIN
Version=18935
0;118.4;1520;684.6;407.842;-21.72433;1;True;False
...
Node;AmplifyShaderEditor.Vector3Node;22;-1349.42,76.83759;Inherit;False;Global;DRAG_POINT;DRAG_POINT;1;0;Create;True;0;0;0;False;0;False;0,0,0;5.985217,-17.98036,5.74;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;83;-31.2354,-68.37239;Inherit;False;texAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=DBB5B3F4F1750B9FDE1D75BE3DD1401F8EC1A09D