	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 tex2DNode93 = tex2D( _SmileTex, texCoord3 );
				float temp_output_105_0 = ( 1.0 - tex2DNode93.r );
				float4 appendResult106 = (float4(temp_output_105_0 , temp_output_105_0 , temp_output_105_0 , 0.0));
				float temp_output_101_0 = ( ( TIME_FADE * 2.0 ) - 1.0 );
				float2 texCoord90 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float simplePerlin2D87 = snoise( texCoord90*2.0 );
				simplePerlin2D87 = simplePerlin2D87*0.5 + 0.5;
				float smoothstepResult89 = smoothstep( temp_output_101_0 , ( temp_output_101_0 + 1.0 ) , simplePerlin2D87);
				float smileFade102 = smoothstepResult89;
				float4 lerpResult108 = lerp( tex2DNode93 , appendResult106 , smileFade102);
				float4 lerpResult94 = lerp( lerpResult108 , tex2D( _MainTex, texCoord3 ) , smileFade102);
				...
				float lerpResult85 = lerp( (( _Tearing )?( lerpResult79 ):( 0.0 )) , 1.0 , (float)DEBUG);
				clip( lerpResult85 - 0.5);
				float4 break44 = lerpResult94;
...
/*ASEBEGIN
Version=18935
-1781;39;1518;738;2309.609;1131.852;1.32125;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;109;-2439.151,1571.503;Inherit;False;1285.628;522.6001;Comment;8;92;99;90;101;87;95;89;102;DissolveMask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;3;-1882.069,-912.9854;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;92;-2323.336,1949.605;Inherit;False;Global;TIME_FADE;TIME_FADE;5;0;Create;True;0;0;0;False;0;False;0;0.45;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;22;-1349.42,76.83759;Inherit;False;Global;DRAG_POINT;DRAG_POINT;1;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;20;-1340.823,-89.22693;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;72;-760.9713,-1057.839;Inherit;True;Property;_TearMask;TearMask;3;0;Create;True;0;0;0;False;0;False;-1;None;17b78c25296033a44868bd92734def64;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;99;-2112.369,1959.103;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;90;-2389.151,1627.452;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;73;-400.7065,-1034.584;Inherit;False;Property;_UseGreenMask;UseGreenMask;4;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;101;-1970.369,1868.103;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;87;-2143.597,1621.503;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;1,1;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;95;-1745.37,1808.103;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;37;-1011.679,273.8734;Inherit;False;36;angle;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;74;-116.0215,-1033.196;Inherit;False;mask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;89;-1596.777,1628.042;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;93;-1202.063,-735.7814;Inherit;True;Property;_SmileTex;SmileTex;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;105;-852.1664,-548.2227;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;102;-1377.523,1626.035;Inherit;False;smileFade;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;106;-686.6953,-547.7517;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;2;-1188.217,-514.8651;Inherit;False;0;0;_MainTex;Shader;False;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;107;-524.1038,-594.6968;Inherit;False;102;smileFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;76;157.543,1094.647;Inherit;False;74;mask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;108;-507.4899,-718.5068;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;103;-317.8947,-306.3869;Inherit;False;102;smileFade;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;83;-361.2008,448.8;Inherit;False;Global;DEBUG;DEBUG;6;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.SamplerNode;4;-1187.168,-437.9663;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;85;-152.2008,407.8;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;94;-300.1413,-449.0514;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=53EA38970C578984C2A42431FAF531F0B8C4C183